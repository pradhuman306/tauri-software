          ...
          <table>
            <tr>
              <td>
                ...
                <select value={selectedCId} name="name" id="name" className="customer-name" onChange={onChangeSet} required>
            ...
            <tr>
              <td>
                ...
                <select value={selectedCId} name="customer" id="customer" className="customer-name" onChange={onChangeSet} required>
